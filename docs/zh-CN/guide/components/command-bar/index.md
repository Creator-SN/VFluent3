...
| 属性                  | 类型    | 必填  | 默认值   | 说明                                                             |
|:---------------------:|:-------:|:-----:|:--------:|:----------------------------------------------------------------:|
| modelValue            | object  | 否    | {}       | 绑定当前选中的对象。                                             |
| options               | array   | 否    | []       | CommandBar 数据源。                                              |
| toward                | string  | 否    | 'down'   | 下拉菜单的朝向。                                                 |
| background            | string  | 否    | ''       | CommandBar 背景。                                                |
| dropDownBackground    | string  | 否    | ''       | 下拉菜单背景。                                                   |
| compact               | boolean | 否    | false    | 紧凑样式。                                                       |
| revealBorderColor     | boolean | 否    | false    |                                                                  |
| revealBackgroundColor | boolean | 否    | false    |                                                                  |
| itemBorderRadius      | number  | 否    | 6        | 项目圆角半径。                                                   |
