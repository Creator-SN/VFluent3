...
<ClientOnly>
<fv-callout :lockScroll="true" :position="position.key" :beak="beak" :space="space" :calloutBg="color" :borderRadius="12" theme="dark" >
...
| borderRadius| number/string | No | 5             | Border radius of the callout panel.  |
