...
| panelClassName | string | No       | ''                                                                                                               | Extra class name passed to the root NavigationPanel element.             |
| mobileControlBackground | string | No | ''                                                                                                               | Background color of the mobile floating control area passed to NavigationPanel. |
