...
| 属性                  | 类型    | 必填  | 默认值                | 说明                         |
|:---------------------:|:-------:|:-----:|:---------------------:|:----------------------------:|
| modelValue            | array   | 否    | []                    | 数据，详见data               |
| draggable             | boolean | 否    | false                 | 是否可拖动。                 |
| checkable             | boolean | 否    | false                 | 是否可选。                   |
| space                 | number  | 否    | 20                    | 树形父与子间的间距(px)       |
...
| showLoading           | boolean | 否    | false                 | 加载时是否显示进度条。       |
| expandedIconPosition  | string  | 否    | 'left'                | 扩展箭头位置。               |
| expandClickMode       | string  | 否    | 'normal'              | 点击展开的方式。             |
