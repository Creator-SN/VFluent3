    ...
    >
        ...
        >
            ...
            <div
                ...
                :style="{
                    width: !vertical ? finalLeft + btnEl.width / 2 + 'px' : '',
                    height: vertical ? finalTop + btnEl.height / 2 + 'px' : '',
                    background: color
                }"
            ></div>
            <div
                ...
                :style="{
                    left: !vertical
                        ? finalLeft - 20 + btnEl.width / 2 + 'px'
                        : '',
                    top: vertical ? finalTop - 14 + btnEl.height / 2 + 'px' : ''
                }"
            >
                <slot :modelValue="progress">
                    <p>{{ progress }}</p>
                </slot>
            </div>
            <div class="fv-slider-unit-container">
                <i
                    ...
                    :style="{
                        left: !vertical
                            ? `calc(${
                                  item.ratio * (barEl.width - btnEl.width) +
                                  btnEl.width / 2
                              }px)`
                            : '',
                        top: vertical
                            ? `calc(${
                                  item.ratio * (barEl.height - btnEl.height) +
                                  btnEl.height / 2
                              }px)`
                            : ''
                    }"
...
export default {
    ...
    data() {
        return {
            progress: this.getValue(this.modelValue), //percent,
            moveable: false,
            mouseDownPos: {
                disX: 0,
                disY: 0
