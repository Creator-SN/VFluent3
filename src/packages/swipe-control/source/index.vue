            ...
            this.swiper = new Swiper(this.$refs.container, {
                ...
                on: {
                    ...
                    transitionEnd: (swiper, event) => {
                        this.triggerType = 'auto';
                        this.refreshProgress(swiper);
                        if (this.status == 'rightFull')
                            this.callFunc(
                                this.thisOptions[this.thisOptions.length - 1]
                            );
                        else if (this.status == 'leftFull')
                            this.callFunc(
                                this.thisLeftOptions[
                                    this.thisLeftOptions.length - 1
                                ]
                            );
                    }
                }
