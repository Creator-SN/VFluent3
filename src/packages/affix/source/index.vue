<template>
    <div
        :class="['fv-Affix', $theme]"
        :style="{
            position: mode === 'fixed' ? 'absolute' : '',
            width: isFixed ? computedWidth : 'auto',
            height: isFixed ? computedHeight : 'auto'
        }"
    >
        <div
            ...
            :style="{
                ...
                left: isFixed ? computedLeft : '',
                top: isFixed ? computedTop : '',
                right: isFixed ? computedRight : '',
                bottom: isFixed ? computedBottom : '',
                'z-index': zIndex
            }"
        >
            <slot> Affix TEMPLATE </slot>
        </div>
    </div>
</template>
